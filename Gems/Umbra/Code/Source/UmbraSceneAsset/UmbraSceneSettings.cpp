        ...
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto editContext = serializeContext->GetEditContext())
            {
                editContext->Class<UmbraSceneSettings>("UmbraSceneSettings", "")
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &UmbraSceneSettings::m_smallestHole, "Smallest Hole", "The smallest size of a gap or voxel that the system sees through when computing visibility data.")
                    ->Attribute(AZ::Edit::Attributes::Suffix, "m")
                    ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                    ->Attribute(AZ::Edit::Attributes::SoftMin, 0.0f)
                    ->Attribute(AZ::Edit::Attributes::SoftMax, 10.0f)
                    ->DataElement(AZ::Edit::UIHandlers::Slider, &UmbraSceneSettings::m_smallestOccluder, "Smallest Occluder", "The smallest size of a feature or geometry recognized as an occluder when computing visibility data.")
                    ->Attribute(AZ::Edit::Attributes::Suffix, "m")
                    ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                    ->Attribute(AZ::Edit::Attributes::SoftMin, 0.0f)
                    ->Attribute(AZ::Edit::Attributes::SoftMax, 10.0f)
